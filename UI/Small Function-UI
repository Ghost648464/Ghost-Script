...
local Script_Title = "Ghost <font color=\"rgb(255, 0, 0)\">|</font> Ui Lib"
...
Ghost.Name = "Ghost"
Ghost.Enabled = true
Ghost.ResetOnSpawn = true
Ghost.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Ghost.DisplayOrder = 999999999
...
Logo.ZIndex = 2
Logo.Image = "http://www.roblox.com/asset/?id=78699805802392"
...
local success, err = pcall(function()
	Ghost.Parent = uiparent()
end)

if not success then
	Ghost.Parent = game:GetService("Players").LocalPlayer.PlayerGui
end
